 ...
 */
export const DetailModal = ({ isOpen, onClose, title, subtitle, fields = [] }) => {
                    ...
                    <div className="space-y-4">
                        {fields.map((field, idx) => {
                            ...
                            return (
                                ...
                                >
                                    <span className={`text-sm font-medium text-gray-500 w-32 shrink-0 ${field.isLong ? '' : 'pt-0.5'}`}>
                                        {field.label}
                                    </span>
                                    {/* break-keep: 한글 줄바꿈 방지, break-all: 긴 영어 주소 등 줄바꿈 */}
